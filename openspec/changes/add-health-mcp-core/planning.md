...
71 delta nodes: 23 stated, 48 partly-inferred, 0 inferred.
Decided by: 11 human, 2 agent-proposed-human-approved, 58 agent-decided.
...
Conversation: openspec/changes/add-health-mcp-core/conversation.md, cited 32 times. Read it for the why before calling anything inferred.
